...
echo "Command: nextflow run metagenome_assembly_classification_workflow_en.nf -c metagenome_assembly_classification_en.config -resume --input samplesheet.csv --outdir results --virsorter2_db $VIRSORTER2_DB --deepvirfinder_dir $DEEPVIRFINDER_DIR"
echo ""
echo "📝 Workflow steps:"
...
echo "✅ Note: -resume enabled (will skip completed steps)"
echo ""
