...
- Confidence: ⭐⭐⭐⭐⭐
- Description: **Four-way validation**
  1. ✅ Assembled by MEGAHIT
  2. ✅ Assembled by SPAdes
  3. ✅ Identified as viral by VirSorter2
  4. ✅ Identified as viral by DeepVirFinder
...
```bash
# Submit to SLURM (script includes -resume parameter by default)
...
**About -resume parameter**:
- ✅ The script **enables** `-resume` parameter by default
- ✅ If job is interrupted or fails, rerun will automatically skip completed steps
- ✅ Only re-runs failed or incomplete steps, saving significant time
- ✅ Even if parameters are modified, completed steps are cached
...
Total unique viral sequences:          200

Consensus viral sequences (both):      130
MEGAHIT only:                          20
SPAdes only:                           50

Assembler consistency:                 65.00%

====================================================================================================
[Recommendation]
----------------------------------------------------------------------------------------------------
High-confidence viral sequences (identified by both methods): 130
...
Format:
```
# High-confidence viral sequences (MEGAHIT and SPAdes consensus)
# Sample: sample1
# Consensus sequences: 130
#
k141_123456
k141_234567
k141_345678
...
### 4. Use -resume (Enabled by Default)

```bash
# Script includes -resume parameter by default
sbatch run_metagenome_assembly_classification_en.sh

# -resume will automatically:
# ✅ Skip successfully completed steps
# ✅ Re-run only failed steps
# ✅ Continue from interruption point, saving significant time
# ✅ Cache intermediate results, speeding up repeated runs

# If complete rerun needed (clear cache):
nextflow clean -f
rm -rf work/
sbatch run_metagenome_assembly_classification_en.sh
```
...
- ✨ Three-level validation system
- ✨ Enable `-resume` parameter by default
